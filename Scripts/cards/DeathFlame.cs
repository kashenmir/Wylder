...
public class DeathFlame : AshWarModel
{
    // 基础耗能
    ...
    // 卡牌的基础属性（例如这里是12点伤害）
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(6, ValueProp.Move), new IntVar("frost", 6), new Chase(5)];
    ...
    public DeathFlame() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    {
        base.DynamicVars["Chase"].UpgradeValueBy(3m);
    }
}