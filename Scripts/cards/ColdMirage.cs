...
public class ColdMirage : TestCardModel
{
    // 基础耗能
    ...
    [
        HoverTipFactory.FromPower<FrostBase>(), HoverTipFactory.FromPower<Frost>(),
        HoverTipFactory.FromPower<IntangiblePower>()
    ];
    
    public ColdMirage() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
