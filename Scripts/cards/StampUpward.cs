...
public class StampUpward : AshWarModel
{
    // 基础耗能
    ...
    // 卡牌的基础属性（例如这里是12点伤害）
    protected override IEnumerable<DynamicVar> CanonicalVars => [new BlockVar(8, ValueProp.Move), new Chase(5)];
    
    public override bool GainsBlock => true;

    public StampUpward() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
