...
public class LightningSpear : TestCardModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(9, ValueProp.Move), new IntVar("weak", 1)];

    public override IEnumerable<CardKeyword> CanonicalKeywords => [MyKeywords.CapitalDragon];

    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPower<WeakPower>()];

    public LightningSpear() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
