...
public class GravityBall : TestCardModel
{
    ...
    public override IEnumerable<CardKeyword> CanonicalKeywords => [MyKeywords.Gravity, CardKeyword.Innate, CardKeyword.Exhaust];

    public GravityBall() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
