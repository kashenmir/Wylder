...
public class GlintstoneIcecrag : TestCardModel
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(6, ValueProp.Move), new IntVar("frost", 6), new IntVar("chargeFrost", 3)];

    public override IEnumerable<CardKeyword> CanonicalKeywords => [MyKeywords.SnowSorcery];

    public GlintstoneIcecrag() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        if (charge != null && charge.Amount > 0)
        {
            ...
            frostAmount += DynamicVars["chargeFrost"].IntValue;
        }

        await PowerCmd.Apply<FrostBase>(choiceContext, cardPlay.Target, frostAmount, Owner.Creature, this);
    }
    ...
    protected override void OnUpgrade()
    {
        ...
        DynamicVars["chargeFrost"].UpgradeValueBy(2m);
    }
}
