...
public class BriarsOfSin : TestCardModel
{
    ...
    public BriarsOfSin() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<BloodBase>(choiceContext, cardPlay.Target, DynamicVars.Damage.IntValue, Owner.Creature, this);
    }
