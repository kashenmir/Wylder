...
public class FrostMist : AshWarModel
{
    // 基础耗能
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPower<FrostBuffPower>(), HoverTipFactory.FromPower<FrostBase>(), HoverTipFactory.FromPower<Frost>()];

    public FrostMist() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
