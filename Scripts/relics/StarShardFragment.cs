...
public class StarShardFragment : CustomRelicModel
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromCard<StarSharp>()];
    ...
    public override async Task BeforeHandDraw(Player player, PlayerChoiceContext choiceContext, ICombatState combatState)
    {
        ...
        {
            Flash();
            CardModel card = combatState.CreateCard<StarSharp>(Owner);
