...
public class CrimsonwhorlBubbletearRelic : CustomRelicModel
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPotion<CrimsonwhorlBubbletear>()];

    public override async Task AfterObtained()
    {
        await PlayerCmd.GainMaxPotionCount(DynamicVars["PotionSlots"].IntValue, Owner);
        PotionModel potion = ModelDb.Potion<CrimsonwhorlBubbletear>().ToMutable();
