...
public class ScarletDewBubbletearRelic : CustomRelicModel
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromPotion<ScarletDewBubbletear>()];

    public override async Task AfterObtained()
    {
        await PlayerCmd.GainMaxPotionCount(DynamicVars["PotionSlots"].IntValue, Owner);
        PotionModel potion = ModelDb.Potion<ScarletDewBubbletear>().ToMutable();
