...
public class Wylder : PlaceholderCharacterModel
{
    // 角色名称颜色
    ...
    // 人物模型tscn路径。要自定义见下。
    public override string CustomVisualPath => "res://wylder/scenes/wylder_character.tscn";
    // 卡牌拖尾场景。
    // public override string CustomTrailPath => "res://scenes/vfx/card_trail_ironclad.tscn";
    // 人物头像路径。
    public override string CustomIconTexturePath => "res://wylder/images/char_select_wylder.png";
    // 人物头像2号。
    public override string CustomIconPath => "res://wylder/scenes/wylder_icon.tscn";
    // 能量表盘tscn路径。要自定义见下。
    public override string CustomEnergyCounterPath => "res://wylder/scenes/wylder_energy_counter.tscn";
    // 篝火休息场景。
    public override string CustomRestSiteAnimPath => "res://wylder/scenes/wylder_rest.tscn";
    // 商店人物场景。
    public override string CustomMerchantAnimPath => "res://wylder/scenes/wylder_merchant.tscn";
    // 多人模式-手指。
    ...
    // 人物选择背景。
    public override string CustomCharacterSelectBg => "res://wylder/scenes/wylder_bg.tscn";
    // 人物选择图标。
    public override string CustomCharacterSelectIconPath => "res://wylder/images/char_select_wylder.png";
    // 人物选择图标-锁定状态。
    public override string CustomCharacterSelectLockedIconPath => "res://wylder/images/char_select_wylder_locked.png";
    // 人物选择过渡动画。
    // public override string CustomCharacterSelectTransitionPath => "res://materials/transitions/ironclad_transition_mat.tres";
    // 地图上的角色标记图标、表情轮盘上的角色头像
    public override string CustomMapMarkerPath => "res://wylder/images/wylder_icon.png";
    // 攻击音效
