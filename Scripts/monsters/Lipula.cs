...
public class Lipula : CustomMonsterModel
{
    ...
    protected override MonsterMoveStateMachine GenerateMoveStateMachine()
    {
        ...
        return new MonsterMoveStateMachine([open, basicAttack, heavyAttack], open);
    }
    ...
    {
        // 说话
        TalkCmd.Play(L10NMonsterLookup("WYLDER-LIPULA.moves.BASIC_ATTACK.banter"), Creature, VfxColor.Blue);
        await DamageCmd
            .Attack(BasicDamage)
            .FromMonster(this)
