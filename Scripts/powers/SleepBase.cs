...
public class SleepBase : CustomPowerModel
{
    ...
    public override string? CustomPackedIconPath => "res://wylder/powers/sleep_base.png";
    public override string? CustomBigIconPath => "res://wylder/powers/sleep_base.png";
