...
public class RotGreasePower : BasicBuffPower
{
    // 自定义图标路径。1:1即可。原版游戏大图256x256，小图64x64。
    public override string? CustomPackedIconPath => "res://wylder/powers/rot_grease_power.png";
    public override string? CustomBigIconPath => "res://wylder/powers/rot_grease_power.png";
